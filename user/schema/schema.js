...
const RootQuery = new GraphQLObjectType({
  ...
  fields: {
    user: {
      ...
      // used for retrieve actual information from database, args parameter in resolve takes the value from args defined above
      resolve(parentValue, args) {
...
const mutation = new GraphQLObjectType({
  ...
  fields:{
    ...
    editUser:{
      type: UserType,
      args:{id:{type: new GraphQLNonNull(GraphQLString)},firstName: {type: GraphQLString}, age: {type: GraphQLInt}, companyId: {type: GraphQLString}},
      resolve(parentValue, args){
